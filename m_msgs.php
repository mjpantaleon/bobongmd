    ...
    <div class="center" style="margin-top: 15px; margin-right: 5px; width: 97%;">
    	 ...
    	 <div class="left" style=" border-top-left-radius: 0.3em; border-top-right-radius: 0.3em; ">
             <div class="header_arrow">
                <span class="left">
                    <img src="images/icons/message.png" width="20" height="20" style="margin-top: 2px;" />&nbsp;Recent Conversations >
                    <?php echo $r_FN; ?></span><span class="arrow">
                </span>
             </div>
         </div>
				...
				while($row	= mysql_fetch_array($result))
				{
					...
					$table.="
							...
							<div style=' margin: -55px 0 0 75px;'>
								<div class=' left'>
									<a href='#' title='View message of '.$r_FN.''><h5>".$e_FN."</h5></a>
								</div>
...
<td width="25%" valign="top" align="center" style="border-left:1px solid #999;">
    ...
    <div style="margin-top: 15px; margin-left: 5px; margin-right: 5px;">
            ...
            background-color:#b6e56d">
            	<img src="images/icons/toolbar-icons/user.png" width="16" height="16" />&nbsp;Recent Conversations
            </div>
	...
	SELECT *
				...
				LEFT JOIN user_details
				ON msgs.msgFrom = user_details.UID
				WHERE msgFrom ='".$UID."' OR msgTo = '".$UID."' AND ST = '1'
				ORDER BY TS DESC LIMIT 0, 30
	*/
		...
		else
		{
			...
			<tr>
				<td rowspan='2' class='left' style=' background-color: #fff; padding-bottom: 2px; padding-top: 5px;'>
					<a href='m_msgs.php?user=".$r_UN."&ts=".$TS."'>
						<img src='".$r_PIC."' width='40' height='40' style='border: 1px solid #999;' title='Click me' />
					</a>
				</td>
				<td class='left' style=' padding-bottom: 2px; padding-top: 5px;'>".$r_FN."</td>
