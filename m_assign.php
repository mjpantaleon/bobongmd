...
<td width="75%" valign="top" align="left">
	...
	<div class="left" style="height:70px; background-color: #9C6;">
        ...
        <span class="okw"><img src="images/icons/toolbar-icons/folder.png" width="20" height="20" style="margin-top: 5px;" />&nbsp;ASSIGNMENTS</span>
    ...
    <div class="center" style="margin-top: 15px; margin-right: 5px; width: 97%;">
    	 ...
    	 <div class="left" style=" border-top-left-radius: 0.3em; border-top-right-radius: 0.3em; ">
             <div class="header_arrow">
                <span class="left">
                    <img src="images/icons/toolbar-icons/folder.png" width="20" height="20" style="margin-top: 2px;" />&nbsp;Assignments Section
                </span>
         ...
         <div id="txtHint" class="left" style=" margin-top: 15px; margin-bottom: 15px;">
			...
			$query	= mysql_query(" SELECT COUNT(`id`) FROM `assignment` WHERE A_ST = '0' ")		//this only serves as a counter
			or die(mysql_error());
					...
					<td>
						<div class='userRow' style=' margin: 25px 15px; box-shadow: 0 1px 3px #FFF; padding: 5px;'>
							<div class='colWrap_left'>
								<div class='picWrap'>
									<a href='m_assign_details.php?user=".$r_UN."&ts=".$r_ID."' title='View Assignment of ".$r_FN."'' alt='View Assignment'>
										<img src='".$r_PIC."' width='95px' height='95px' />
									</a>
								</div>
								...
								<div class='UserFNwrap'>
									<div class='userFN'>
										<a href='m_assign_details.php?user=".$r_UN."&ts=".$r_ID."' title='View Assignment of ".$r_FN."'' alt='View Assignment'>
											<p>".substr($r_SUB, 0, 35)."...</p>
										</a>
									</div>
								</div>
								
								<div class='msgIconWrap'>
									<div class='right'><span class='s_normal'>".$dateS."</span></div>	
								</div>
							</div>
						</div>
					</td>
