...
?>
	...
	***********************************************/
	...
	<div style=" padding: 5px; margin: 15px; border: 1px dashed #CCC; background: #FFF;">
		<div class="right">
			
			<script type="text/javascript">new pausescroller(pausecontent2, "pscroller2", "someclass", 2500)</script>	
		</div>
	</div>
