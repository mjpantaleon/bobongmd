				...
				if($Count < $Limit)
				{
					...
					<div style=' margin: 25px 10px; '>
						...
						border: 1px solid #CCC; box-shadow: 0 1px 5px #CCC; background-color:#FFF;'>
							...
							<div class='blogTitle'>
								<div class='left'>
									<h3><a href='g_blogs_details.php?blogID=".$r_id."' title='View this blog'>".$r_TIT."</a></h3>
								</div>
							</div>
							...
							<div class='blogDetails' style='margin: 18px 8px 8px;'>
									...
									<a href='g_blogs_details.php?blogID=".$r_id."' title='view comments of this blog'>Comments</a></span> |
									<span class='ss_normal'>(".$r_like.") 
									<a href='g_blogs_details.php?blogID=".$r_id."' title='view likes of this blog'>Likes</a> </span>
							</div>
							
							<div style=' height: 55px; padding: 3px; border-top: 1px solid #CCC; background-color:#F1F1F1;'>
								<div  class='left'>
									<span class='s_normal'>Uploaded by
										<a href='g_blogs_details.php?blogger=".$r_UID."' title='View Blogs of this person'>".$r_FN."</a><br />
								...
								<div class='right'>
									...
									if($r_UID == $UID)
									{
										...
										<a href='g_blogs_edit.php?blogID=".$r_id."' title='Edit this blog' >Edit</a>
										";
									}
									//if user is same with the logged user then
