...
<div id="inboxBG3" onclick="hideShowInbox3()"></div>
<div id="inboxFG3">
	<!-- CONTENT HERE -->
    	...
    	<div class="left">
            ...
            font-size:18px; text-align:left; border-bottom: 1px solid #999;">
              ...
              <img src="images/icons/x.png" width="20" height="20" onClick="hideShowInbox3()" title="Close">
				...
				$divResult = "
				 ...
				 <div style=' border:1px dashed #CCC; margin: 25px 15px 15px; background-color:#FFF; padding: 3px; height: 70px; box-shadow: 0 1px 3px #999;'>
					<div style='border: 1px solid #999; background-color: #FFF; height:65px; width: 65px; margin: -17px 0 0 0;'>
						<div class='center'>
							<a href='m_msgs.php?user=".$r_UN."&ts=".$r_TS."'><img src='".$r_PIC."' width='65' height='65' title='View message of ".$r_FN."'></a>
						</div>
					</div>
					
					<div style=' margin: -55px 0 0 75px;'>
						<div class=' left'><a href='m_msgs.php?user=".$r_UN."&ts=".$r_TS."' title='View message of ".$r_FN."'><h5>".$r_FN."</h5></a></div>
					</div>
